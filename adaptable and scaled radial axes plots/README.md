Libraries in *Matlab*, *Python* and *R* for several data visualization methods based on radial axes: Star Coordinates, RadViz, Adaptable Radial Axes PLots, Scaled Radial Axes, etc.
